<html>
    ...
    <body>
        ...
        <form action="question_view.php" method="post">
            <div class='bg-light border border-info row p-2 ml-2 mr-2 mt-3 pb-3'>
                <div class='col-md-12'>
                    <h1 class='text-center' style='font-weight:300;'>View Question</h1>
            ...
            <div class='bg-light border border-info row p-2 ml-2 mr-2 mt-1 pb-3'>
                <div class='col-md-3'>
                    ...
                    <div class='col-md-6'>
                        <?php
                            if((isset($_POST['branchlist']) == true) && (isset($_POST['semesters']) == true) && (isset($_POST['subjects']) == true)){
                                question_view($_POST['subjects'], $_POST['branchlist'], $_POST['semesters']) ;
                            }else{
                                echo "No details";
                            } 
